...
<head>
  ...
  <?php print $styles ?>
  <script type="text/javascript" src="sites/all/themes/dmps/js/focus.js"></script>
  <script type="text/javascript" src="sites/all/themes/dmps/js/jquery.js"></script>
  <script type="text/javascript" src="sites/all/themes/dmps/js/sudo.js"></script>
  <script type="text/javascript" src="sites/all/themes/dmps/js/functions.js"></script>
